...
class PVD_Color_Schemes {
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'80s-kid', __( '80\'s Kid', 'pvd_colors' ),
		...
		wp_admin_css_color(
			'aubergine', __( 'Aubergine', 'pvd_colors' ),
		...
		wp_admin_css_color(
			'seashore', __( 'Seashore', 'pvd_colors' ),
